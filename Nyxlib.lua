...
do
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        ToggleOuterCorner.CornerRadius = UDim.new(0, 3);
...
function Library:CreateWindow(...)
    ...
    local MainSectionOuterCorner = Instance.new('UICorner');
    MainSectionOuterCorner.CornerRadius = UDim.new(0, 6);
    MainSectionOuterCorner.Parent = MainSectionOuter;
    ...
    function Window:AddTab(Name)
        ...
        function Tab:AddGroupbox(Info)
            ...
            BoxOuterCorner.CornerRadius = UDim.new(0, 6);
            BoxOuterCorner.Parent = BoxOuter;

            -- Bordure subtile via UIStroke
            local BoxStroke = Instance.new('UIStroke');
            BoxStroke.Color = Library.OutlineColor;
            ...
            local BoxInnerCorner = Instance.new('UICorner');
            BoxInnerCorner.CornerRadius = UDim.new(0, 6);
            BoxInnerCorner.Parent = BoxInner;

            -- Accent line en haut (plus fine et élégante)
            local Highlight = Library:Create('Frame', {
                BackgroundColor3 = Library.AccentColor;
                BorderSizePixel = 0;
